        ...
        {!user ? (
          ...
          <>
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-3 py-2 md:px-4 md:py-2 rounded-sm text-sm font-medium transition-colors duration-200"
            >
              Log Out
            </button>
            <Link
              to={"/cart"}
              className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 md:px-4 md:py-2 rounded-sm text-sm font-medium transition-colors duration-200"
            >
